const skills = {
  ...
  tools: [
    ...
    },
    {
      ...
      isRecent: true,
      description: {
        en: 'I use Docker daily in enterprise environments to build, run, and maintain services with reliable local parity, reproducible deployments, and operational consistency across teams.',
        es: 'Utilizo Docker a diario en entornos corporativos para construir, ejecutar y mantener servicios con paridad local fiable, despliegues reproducibles y consistencia operativa entre equipos.',
      },
      era: 'platform',
    },
    {
  ...
  other: [
    ...
    },
    {
      ...
      description: {
        ...
        es: 'Elaboro documentación técnica clara para arquitectura, operaciones y flujos de entrega, ayudando al equipo a ejecutar con menos ambigüedad y mejor onboarding.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Diseño e imparto formaciones técnicas que elevan la capacidad del equipo en arquitectura, estándares de entrega y prácticas de plataforma.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Gestiono talento técnico mediante coaching, priorización y responsabilidad, manteniendo alta calidad de ejecución y crecimiento profesional.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Utilizo herramientas no-code cuando aceleran experimentación, flujos internos o integraciones sin comprometer la fiabilidad.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Diseño arquitecturas de solución que alinean restricciones de negocio, estrategia técnica y viabilidad de entrega entre equipos.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Trabajo de cerca con stakeholders para convertir objetivos de negocio en roadmaps técnicos, decisiones de trade-off y resultados medibles.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Aplico patrones de arquitectura cloud para escalabilidad, fiabilidad y operaciones eficientes en coste en entornos de producción.',
      },
    },
    {
      skill: 'AI Adoption',
      ...
      description: {
        ...
        es: 'Impulso una adopción práctica de IA definiendo guardrails, validando casos de uso e integrando IA en procesos de entrega con KPIs claros.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Diseño pensando en escalabilidad, mejorando rendimiento, resiliencia y mitigación de cuellos de botella en sistemas distribuidos.',
      },
    },
    {
      skill: 'DevOps',
      ...
      description: {
        ...
        es: 'Aplico prácticas DevOps que conectan desarrollo y operaciones mediante automatización, observabilidad y pipelines de despliegue más seguros.',
      },
    },
    {
      skill: 'Azure Entra',
      ...
      description: {
        ...
        es: 'Utilizo Azure Entra para gestión de identidades y accesos, incluyendo flujos de autenticación y control de acceso por roles.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Despliego y opero servicios web en Azure App Service, con foco en fiabilidad, configuración segura y eficiencia operativa.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Aplico principios de arquitectura limpia para separar responsabilidades, reducir acoplamiento y facilitar la evolución del código.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Trabajo con Microsoft SQL Server para modelado relacional, optimización de consultas e integración en aplicaciones de estilo enterprise.',
      },
    },
    {
      skill: 'Microservices',
      ...
      description: {
        ...
        es: 'Construyo microservicios de alto rendimiento con límites claros, integración asíncrona y enfoque en fiabilidad en producción.',
      },
    },
    {
      skill: 'Mentoring',
      ...
      description: {
        ...
        es: 'Mentorizo ingenieros mediante feedback estructurado, coaching técnico y planes de crecimiento que aumentan la autonomía del equipo.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'He trabajado con Amazon DynamoDB en proyectos académicos y conozco conceptos clave de modelado de datos key-value y documento.',
      },
    },
    {
      skill: 'AWS Lambda',
    ...
    },
    {
      ...
      description: {
        ...
        es: 'He integrado Amazon Cognito para autenticación de usuarios y gestión de identidad en aplicaciones sobre cloud.',
      },
    },
    {
      skill: 'AWS CLI',
      ...
      description: {
        ...
        es: 'Utilizo AWS CLI para automatización, gestión de entornos y scripting operativo en flujos cloud.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Implemento flujos de autenticación y autorización basados en JWT para APIs y servicios distribuidos.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Tengo experiencia base con Oracle Database en contexto académico, incluyendo diseño de esquemas y consultas SQL.',
      },
    },
    {
      skill: 'English (C1)',
      ...
      description: {
        ...
        es: 'Trabajo en inglés con nivel profesional C1 para comunicación técnica, discusiones de arquitectura y alineación con stakeholders.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Construyo aplicaciones frontend en producción con foco en usabilidad, rendimiento, accesibilidad y arquitectura de componentes mantenible.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Aplico patrones de diseño de software de forma pragmática para mejorar legibilidad, extensibilidad y consistencia de implementación.',
      },
    },
    {
      skill: 'A/B Testing',
      ...
      description: {
        ...
        es: 'He utilizado pruebas A/B para validar hipótesis de UX y medir impacto de producto con decisiones guiadas por datos.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Gestiono entregas técnicas en entornos ágiles, equilibrando compromisos de roadmap, gestión de riesgos y capacidad del equipo.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Utilizo metodologías ágiles para estructurar planificación, entrega incremental y colaboración entre equipos.',
      },
    },
    {
      ...
      description: {
        ...
        es: 'Tengo base sólida en bases de datos relacionales, incluyendo diseño de esquemas, normalización, estrategia de índices y rendimiento de consultas.',
      },
    },
    {
      skill: 'Spec-Driven Development for AI Agents',
      level: 4,
      isRecent: true,
      era: 'ai',
      description: {
        en: 'I lead spec-driven development practices so AI coding agents can execute safely with clear constraints, tool usage rules, MCP integration boundaries, and organization-specific behavior.',
        es: 'Lidero prácticas de desarrollo guiado por especificaciones para que agentes de código con IA ejecuten de forma segura, con reglas claras de herramientas, límites de integración MCP y comportamiento alineado con la organización.',
      },
    },
    {
      skill: 'Autonomous Agent Loop Operations',
      level: 4,
      isRecent: true,
      era: 'ai',
      description: {
        en: 'I run autonomous agent loops with human review checkpoints, enabling 24/7 execution while maintaining quality control and continuity in long-running workflows.',
        es: 'Opero bucles autónomos de agentes con puntos de revisión humana, permitiendo ejecución 24/7 mientras mantengo control de calidad y continuidad en flujos de larga duración.',
      },
    },
    {
      skill: 'LLM API Inference Integration',
      level: 3,
      isRecent: true,
      era: 'ai',
      description: {
        en: 'I integrate LLM inference APIs into process automation flows, focusing on practical outcomes, reliability checks, and measurable operational value.',
        es: 'Integro APIs de inferencia LLM en flujos de automatización de procesos, con foco en resultados prácticos, controles de fiabilidad y valor operativo medible.',
      },
    },
  ],
}
