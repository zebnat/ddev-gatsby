...
hreflangs:
  [
    'es%%/proyectos/tu-propio-algoritmo-de-google-en-tus-webs/',
    'en%%/en/projects/your-own-rankings-in-your-website/',
  ]
---
...
Bueno, calidad es lo que el usuario quiere, ¿y cómo sabemos lo que quiere el usuario? Sabemos que Google utiliza más de 200 métricas para clasificar los sitios web por cada palabra clave, así que pensé que sería buena idea crear un algoritmo de forma parecida.
