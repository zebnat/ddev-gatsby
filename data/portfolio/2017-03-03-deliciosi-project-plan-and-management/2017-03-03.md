...
hreflangs:
  [
    'es%%/proyectos/planificacion-de-proyecto-deliciosi/',
    'en%%/en/projects/deliciosi-project-plan-and-management/',
  ]
---
...
El producto final es [https://www.deliciosi.com/](https://www.deliciosi.com/), una web optimizada para SEO, muy rápida y con diseño responsive. No tengo ni idea de si la web estará en pie en el momento de visitar este link, así que dejaré algunas capturas más.

_Lista de recetas, página principal_

![Deliciosi](deliciosi-1.jpg)

_Buscador de recetas_
...
_Página de la receta_

![Deliciosi](deliciosi-4.jpg)

_Panel de gestión Angular 2+_
