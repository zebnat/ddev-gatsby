...
hreflangs:
  [
    'es%%/proyectos/spinwheel-un-juego-de-movil-para-la-macrojuegos-app/',
    'en%%/en/projects/spinwheel-mobile-game-for-macrojuegos-app/',
  ]
---

# Desarrollo de un juego de ruleta con Unity
...
_Video de Youtube mostrando el juego siendo jugado_
`youtube:https://www.youtube.com/embed/1Cb6DeebPMM`

_Video de Youtube mostrando un poco de código c# scripts y gameobjects de Unity_
