...
hreflangs:
  [
    'es%%/proyectos/desarrollo-sistema-personalizado-busquedas/',
    'en%%/en/projects/developing-custom-search-solution-inverted-index/',
  ]
---
...
_Ejemplo de un índice invertido ruso con documentos guardados como json_
![índice invertido ruso](example-russian-index.jpg)
