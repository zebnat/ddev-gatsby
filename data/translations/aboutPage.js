const translation = {
  ...
  es: {
    ...
    h1: 'Sobre mi',
    h2: 'Technical Lead en Barcelona centrado en arquitectura, entrega y evolucion con IA.',
    title: 'Sobre mi - Daniel Dominguez',
    intro1:
      'Soy Daniel, Technical Lead con mas de 15 anos construyendo y evolucionando software en produccion.',
    intro2:
      'Actualmente lidero estrategia tecnica en fintech, tomo decisiones de arquitectura y mentorizo a un equipo de 3 ingenieros sin dejar el trabajo hands-on.',
    focus_title: 'Foco actual',
    focus_items: [
      'Technical Lead con responsabilidad en IA',
      'Liderazgo tecnico y mentoring (3 personas)',
      'Cloud, CI/CD y arquitectura escalable',
    ],
    why_title: 'Por que programacion?',
    why_answer:
      'La web permite convertir ideas en productos utiles con gran velocidad. Disfruto simplificando sistemas complejos y entregando soluciones mantenibles.',
    how_i_work_title: 'Como trabajo',
    how_i_work:
      'Alineo arquitectura, procesos y personas: especificaciones claras, ejecucion fiable, observabilidad y mejora continua release tras release.',
    lifestyle_title: 'Fuera del trabajo',
    lifestyle:
      'Mi trayectoria esta marcada por el autoaprendizaje, la curiosidad y la mejora continua. Ese enfoque sigue guiando mi evolucion tecnica.',
    hobbies_title: 'Intereses personales',
    hobbies:
      'Disfruto del senderismo, el entrenamiento de fuerza, la escritura, la ciencia ficcion y la cultura tecnologica. Me ayudan a mantener energia y perspectiva.',
    timeline_title: 'Cronologia',
    timeline: [
      '1985 · Se inicializa la instancia humana.',
      '1990 · Primer ordenador: AMSTRAD CPC.',
      '1998-2001 · Primeras webs y aprendizaje constante con practica.',
      '2009 · Primer puesto profesional como frontend developer.',
      '2010 · Evolucion a responsabilidades full stack.',
      '2013 · Ownership de producto sin dejar la programacion.',
      '2019-2022 · Trabajo remoto full stack mientras continuo formacion oficial.',
      '2023 · Inicio en fintech como Senior Full Stack Developer.',
      '2025 · Promocion a Technical Lead en fintech.',
      'Hoy · Liderando arquitectura, practicas DevOps y adopcion de IA con un equipo de 3.',
    ],
    gallery_title: 'Momentos',
    gallery_intro:
      'Algunas fotos del camino. El contexto humano tambien importa en una carrera tecnica.',
