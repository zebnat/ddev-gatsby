...
const translation = {
	"en" : {
		...
		"hard_road_title": `Difficult roads often lead to beautiful destinations`,
		...
		"difficulties_4": <><b>Not giving up was worth the effort, at 24, i had my first programming job offer, they asked for a Junior Web Developer</b>. I never doubt for a moment and ran away from the work place where i was, a factory where i earned good money and was fun, configuring ABB Robots and some technical stuff there, but my dream was always being a programmer. <a href="https://www.linkedin.com/in/sergio-fernandez-giribets-25805717/" rel="noopener noreferrer" target="_blank">Sergio</a>, Panaworld SL CEO decided to hire me part time. They needed a junior dev to speed up a little bit the software development department. This company had their own products, websites with very high traffic serving for 8 different countries</>,
		...
		"developer_4": <>I don't want to make this longer, if you want more details about the proyects i worked during these times you can find them in the <Link exact to="/en/proyects/">proyects section</Link>. In summary, i developed a 9 year career within Panaworld headquarters doing all sort of stuff related to the web development world, frontend, backend, libraries like jQuery and a lot more. I also learned a lot of SEO since i was in charge of all of it, technical SEO optimizations, semantics, keyword strategy, content strategy, etc. I consider myself a WhiteHat SEO focused on User Experience, Technical optimizations and ONPAGE semantics.</>
	},
	"es" : {
		"bioquote": "Alegrando una cara aburrida con css",
		"h1" : "Cosas sobre mí",
		"h2" : "Quién soy, aficiones, como me hice programador, etc",
		"title" : "Acerca de mí",
		"intro1" : `¡Hey! ¿Que tal? Me llamo Daniel Domínguez Rubio, me apasiona el mundo digital, la programación, diseñar software, interfaces gráficas, el SEO... y un montón de cosas de frikis. Llevo toda la vida viviendo en Barcelona, he trabajado en distintos lugares, pero en mis 9 últimos años de trabajo he ejercido como programador.`,
		"lifestyle" : `Desde siempre he estado vinculado con la <b>informática</b> y rodeado de amigos que también lo están. Por circunstancias de la vida tuve que luchar y aprender de forma autodidacta hasta convertirme en programador. Ahora es tanto mi Hobbie como mi trabajo. Me desenvuelvo como <b>Desarrollador FullStack</b> especializado en WEB, Javascript, Nodejs, PHP, SQL, etc. He tenido la suerte de mantener una estrecha relación con el SEO Técnico, semántico y manejando la estrategia de proyectos SEO durante 7 años.`,
		"howiam" : `¿Que tipo de persona soy?`,
		"howiam_reply" : `Pues creo que soy el <b>arquetipo clásico</b> de programador de toda la vida, nada fuera de lo común. Me considero <b>una persona introvertida</b> y prefiero trabajar en la sala de máquinas, entretenido con mis herramientas y no en la vanguardia de cara al cliente ejerciendo un trabajo más de consultor o vendedor. He trabajado en equipo en algunos proyectos, y otros los he llevado yo solo, así que ya estoy acostumbrado a ambas cosas. He sido durante años la persona que hace de enlace entre el equipo Técnico - SEO - Contenidos y la dirección, para una pequeña startup de entre 8 y 15 empleados ¡había mucho que hacer!.`,
		...
		"history_brief": `A continuación vas a leer sobre mi historia, así que puede ser un poco pesado pero merece la pena si quieres saber más.`,
		...
		"teen_3": <>Todavía no me había tomado en serio el tema de aprender a programar, hasta que <b>descubrí páginas web que cambiaban su contenido</b> (Páginas dinámicas). Tenía que saber como era posible conseguir que el HTML hiciese esto, y fue cuando <b>descubrí los CGI</b>, principalmente todo lo que se podía hacer con <b>PHP</b>. Al investigar más sobre PHP me di cuenta que esto era otro nivel, ya no hablábamos de copiar y pegar scripts, esto era serio, y tenía que aprender de alguna manera. Comencé instalando un CMS popular en la época, <a href="https://es.wikipedia.org/wiki/PHP-Nuke" rel="noopener noreferrer" target="_blank">PHP-NUKE</a> (el wordpress de la época). Me fui buscando la vida para ir editando el código PHP del CMS y poco a poco fui aprendiendo algo más.</>,
		...
		"hard_road_title": `El camino con obstáculos lleva al mejor destino`,
		"difficulties_1": `Estaba finalizando ya primero de bachillerato, acabando una previa del trabajo de investigación de segundo curso, programé un blog casero con php sacando buena nota, todo iba bien pero entonces <b>llegaron algunos problemas</b>. Mi familia no pasaba la mejor época. Mi madre cayó enferma y acabó estando de baja, así que <b>me tocó ayudar en el negocio familiar</b>. No tuvieron en cuenta que el bachillerato no era un camino de rositas, y los fines de semana me tocaba trabajar, sin apenas tiempo para estudiar esto me pasó factura. Acabé suspendiendo las 3 asignaturas menos importantes en un Bachillerato tecnológico, las lenguas. Esto unido a la falta de tiempo para estudiar y energía me hizo pensar sobre mi futuro.`,
		"difficulties_2": `En vista de que al año siguiente iba a tener que continuar trabajando en el negocio familiar, <b>decidí matricularme para un Ciclo de grado medio de tarde</b>, para compatibilizar horarios. Lamentablemente no existían ciclos de informática como ahora, así que me decanté por la electrónica, que era lo más parecido, no estaba mal, aunque tenía pocas salidas laborales. Todo iba bien, se me daba bien la electrónica, pero terminando ya el primer año, mi padre decidió divorciarse y lo hizo, se marchó a otra provincia. Con mi madre aún enferma, tuve presión incluso de familiares para trabajar a tiempo completo y traer dinero a casa.`,
		"difficulties_3": `Tenía casi 18 años cuando empecé a trabajar (aparte del negocio familiar), como dependiente, de peón en la construcción, como carpintero de aluminio y cristalero, en fábricas de metalurgia y cerámica... así mas o menos durante 6 años. A pesar que <b>fue muy duro, no me rendí</b>, en el tiempo libre que me quedaba seguía trasteando con cosas sobre programación WEB. Me puse las pilas con todo lo actual, echaba algunas tardes con mi mejor amigo programando con visual basic, incluso me pareció buena idea desinstalar windows para aprender Linux, así que Debian Lenny fue mi sistema desktop durante 3 o 4 años.`,
		"difficulties_4": <>No abandonar el gremio mereció la pena, a los 24 años tuve la suerte de que <b>me ofrecieron mi primer empleo en el mundo de la programación</b>. No dudé ni un momento en dejar el trabajo donde estaba, una fábrica donde se ganaba muy bien y no estaba mal, tenía acceso a configurar <b>Robots ABB</b> y otros cacharros, pero no podía rechazar la oportunidad de ser programador. <a href="https://www.linkedin.com/in/sergio-fernandez-giribets-25805717/" rel="noopener noreferrer" target="_blank">Sergio</a>, CEO de Panaworld S.L, decidió darme una oportunidad a media jornada en su empresa, necesitaban alguien Junior para apoyar un poco y con ganas de aprender. La empresa tenía un producto propio, una red de páginas web con tráfico en 8 países diferentes.</>,
		"working_as_dev_title": `Como fue trabajar para una empresa sin titulación, siendo programador autodidacta`,
		"developer_1": `Al principio en la empresa me tocó un poco hacer las cosas que no suelen ser divertidas, aprovechando que sabía maquetar con las últimas tecnologías de la época (<b>CSS</b>), me tocó maquetar durante unos meses. Creedme, maquetar con soporte para Internet Explorer 6 no era tan fácil como ahora, por aquel entonces (2009) no existía ni Flexbox, ni frameworks como Bootstrap, ni cssgrid ni ná de ná. Te buscabas la vida con CSS puro tirando de <code>float: left;</code><code>display: table</code> y similares, si funcionaba en IE6 ese día te ibas contento a casa.`,
		"developer_2": `En solo dos meses <b>me hicieron contrato indefinido a jornada completa</b>, demostré que estaba al nivel del resto de compañeros, les ayudé con algunos problemas de sus proyectos. Mejoré el rendimiento del sistema propio que se hicieron para generar páginas estáticas con PHP, no tenían suficiente conocimiento sobre MySQL y sus indices (algo que yo aprendí de buenos libros).`,
		"developer_3": `Tras llevar ya un año en la empresa, me dieron la <b>oportunidad de empezar yo solo el proyecto de futuro de la empresa</b>. Aprendí mucho con este proyecto, desarrollé un framework PHP basado en MVC junto con un compañero, y a partir de ahí pude comenzar a implementar todas las features de backend y frontend. Se buscaba lo que llamaban, tecnología web 2.0,  AJAX, Login de Usuarios, Comunidad, dinamismo por javascript, etc. Tras terminarlo, reemplazó a las webs antiguas en los países que menos visitas generaban. En solo un año <b>mejoró notablemente el SEO y las estadísticas de uso</b>, finalmente desplegamos el proyecto que sustituyó las webs de todos los países, hicimos mucho trabajo de SEO. Este proyecto fue muy interesante, diseñar las bases de datos para que fueran escalables, programar todo el backend, todo el frontend, llevar la estrategia SEO... macrojuegos.com (la página española) alcanzó hasta 70 millones de páginas vistas en un mes.`,
		"developer_4": <>No entraré en más detalles sobre los proyectos que hice, ya que fueron muchos, podéis encontrar esa información en la <Link exact to="/proyectos/">sección proyectos</Link>. A modo de resumen, estuve en PANAWORLD casi 9 años, realizando tareas de maquetación, programación, backend PHP, frontend Javascript, utilizando librerías como jQuery, y algunas que fueron saliendo. Además, estaba a cargo de todos los temas SEO, decidí hacerme cargo de la optimización, tanto técnica como semántica así que descubrí muchas cositas sobre SEO "whitehat" ONPAGE y experiencia del usuario.</>
	}
}
...
const AboutPage = (props) => (
	<>
      ...
      translation[props.lang].intro1}}></p>
		...
		<p dangerouslySetInnerHTML={{
			__html:	translation[props.lang].teen_5}}></p>
		<h4 dangerouslySetInnerHTML={{
			__html:	translation[props.lang].hard_road_title}}></h4>
		<p dangerouslySetInnerHTML={{
			__html:	translation[props.lang].difficulties_1}}></p>
		<p dangerouslySetInnerHTML={{
			__html:	translation[props.lang].difficulties_2}}></p>
		<p dangerouslySetInnerHTML={{
			__html:	translation[props.lang].difficulties_3}}></p>
		<p>{translation[props.lang].difficulties_4}</p>
		<h4 dangerouslySetInnerHTML={{
			__html:	translation[props.lang].working_as_dev_title}}></h4>
		<p dangerouslySetInnerHTML={{
			__html:	translation[props.lang].developer_1}}></p>
		<p dangerouslySetInnerHTML={{
			__html:	translation[props.lang].developer_2}}></p>
		<p dangerouslySetInnerHTML={{
			__html:	translation[props.lang].developer_3}}></p>
