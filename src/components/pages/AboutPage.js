...
const translation = {
  ...
  es: {
    ...
    difficulties_4: (
      <>
        No abandonar el gremio mereció la pena, a los 24 años tuve la suerte de
        que <b>me ofrecieron mi primer empleo en el mundo de la programación</b>
        . No dudé ni un momento en dejar el trabajo donde estaba, una fábrica
        donde se ganaba muy bien y no estaba mal, tenía acceso a configurar{' '}
        <b>Robots ABB</b> y otros cacharros, pero no podía rechazar la
        oportunidad de ser programador.{' '}
        <a
          href="https://www.linkedin.com/in/sergio-fernandez-giribets-25805717/"
          rel="noopener noreferrer"
          target="_blank"
        ...
        su empresa, necesitaban alguien Junior para apoyar un poco y con ganas
        de aprender. La empresa tenía un producto propio, una red de páginas web
