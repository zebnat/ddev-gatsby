...
const About = () => (
  <Layout>
		<Header h1={"Cosas sobre mí"} h2={"Aprende más, a que me dedico, de donde soy, como llegué hasta aquí..."}/>
		<Bio photos={photos} />
		<p>¡Hola! Te daré más detalles sobre mí, me llamo <b>Daniel Domínguez Rubio</b>, soy un chico de <b>{age} años</b> de edad, asi que sí, pertenezco a la <i>Generación Y</i> también conocida como <i>Millenial</i> (si... también soy un poco friki, pero solo un poco).</p>
